    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        for (Part part : req.getParts()) {
            ...
            if( i <=3){
                ...
                if(imageName != null  ){
                    part.write("C:/Users/Chathuranga/IdeaProjects/suwasewana11/src/main/webapp/public/images/uploadimage/"+imageName);
                    System.out.println("C:/Users/Chathuranga/IdeaProjects/suwasewana11/src/main/webapp/public/images/uploadimage/"+imageName);
                }
