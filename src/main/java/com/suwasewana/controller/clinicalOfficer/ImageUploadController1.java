    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        for (Part part : req.getParts()) {
            ...
            if( i <=3){
                ...
                if(imageName != null  ){
                    part.write("D:/suwasewanaP/src/main/webapp/public/images/uploadedImages/"+imageName);
                    System.out.println("D:/suwasewanaP/src/main/webapp/public/images/uploadedImages/"+imageName);
                }
