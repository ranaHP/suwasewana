...
<%--    &lt;%&ndash;    for popup style&ndash;%&gt;--%>
<%--    <link href="<c:url value="/public/css/popup/popup.css"/>" rel="stylesheet"/>--%>
<%--    &lt;%&ndash;    for popup script&ndash;%&gt;--%>
...
<%--                    &lt;%&ndash;                <div class="singal_row">&ndash;%&gt;--%>
...
<%--                            <div class="form-item" >--%>
<%--                                <label style="top: 7px">MOH Area</label> <br>--%>
...
<div class="MR_main_Container">
    ...
    <div class="MR_container">
        <div class="title">
            <span>Register Clinical Officer</span></span>
        </div>
...
<script defer>
    ...
    function registerwithimage(imagearray) {
        ...
        $.post(myUrl+ "/admin-register-controller/clinical_officer",
            reqData,
            function (data, status) {
                console.log(data.includes("success"))
                if (data.includes("success")) {
