                ...
                <div class="live-card-border">
                    <div class="live-card">
                        ...
                        <div class="clinic-details">
                            <div class="location" id="item1"><span><span class="locationimg"><i data-feather="home" width="10px" height="10px"></i></span>Location :</span> home</div>
                            <div class="conduct"  id="item2"><span><span><i data-feather="user" width="10px" height="10px"></i></span>Conduct :</span> Akila Lulakshi</div>
                            <div class="max-limit"  id="item3"><span><span><i data-feather="user-check" width="10px" height="10px"></i></span>Max participant limit :</span>1900</div>
                            <div class="moh-area"  id="4"><span><span><i data-feather="map-pin" width="10px" height="10px"></i></span>MOH Area :</span></div>
                            <div class="target-participants"  id="item5"><span><span><i data-feather="users" width="10px" height="10px"></i></span>Target participant :</span> covid patients</div>
                        </div>
