            ...
            this.conatiner.innerHTML += `<div class="appointmnet-card">
                ...
                <div class="app-data-container">
                    <div class="app-left">
                        ...
                        <tr>
                        <td>
                            From - ${app.appointment.time_slot_1} <br> To - ${app.appointment.time_slot_1_end} 
                        </td>
                        <td>
                           From - ${app.appointment.time_slot_2} <br> To - ${app.appointment.time_slot_2_end} 
                        </td>
                        <td>
                ...
                <div class="action-center">
                    ...
                    ${(app.appointment.status  === "pending") ?  `<div class="btn-set" >
                        <button class="app-submitBtn btn-success" onclick="popup.giveTimeSlot({ id: '\` + app.appointment.app_id +  \`',message: 'Give available time slot!' , title: '\` + app.appointment.aTitle + \`'});"> Give Time Solt</button>
                        <button class="app-submitBtn btn-danger"  onclick="popup.rejectAppointment({ message: 'Reject Appointment' , title: '\` + app.appointment.aTitle + \`'});"> Reject</button>
<!--                        <button class="app-submitBtn btn-primary"  onclick="popup.postPoneAppointment({ message: 'Postpone Appointment' , title: '\` + app.appointment.aTitle +  \`'});"> Postpone</button>-->
                    ...
                    ${(app.appointment.status  === "pending_citizen_action") ?  `<div class="btn-set" >
