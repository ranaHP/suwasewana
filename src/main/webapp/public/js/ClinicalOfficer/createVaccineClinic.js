...
function card()
{
    ...
    var Age =document.getElementById("Age-limit").value;
    ...
    clinic.innerHTML =`
                            ...
                            <div class="clinic-details">
                                ...
                                <div class="Age"  id="item2"><span><object data="${Url}/public/images/icons/user.svg" width="8" height="8"> </object>Age limit : ${Age}</div>
